...
export function MemoryGame({
  ...
  if (isCompleted) {
    ...
    const resultMessage = stars === 3
      ...
      : stars === 2
        ? "Sigue asi! Cada pareja que recuerdas fortalece tu conocimiento sobre lactancia."
  ...
  return (
    ...
    >
      <MusicControl track="piano" volume={0.25} />
        ...
        <div className="grid grid-cols-3 gap-2">
          {cards.map((card) => (
            ...
            >
              ...
              >
                {/* Card Back (face down) */}
                <div className="absolute inset-0 backface-hidden rounded-xl border-2 border-teal-400 shadow-md overflow-hidden">
                  <Image
                    src="/images/nivel5/reverso-tarjetas.jpg"
                    alt="Tarjeta"
                    fill
