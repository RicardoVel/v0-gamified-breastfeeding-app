...
const levelData = {
  1: {
    ...
    correctAnswers: [
      ...
      { text: "Favorece el vinculo madre-hijo", image: "/images/options/vinculo-emocional.png", feedback: "El contacto piel a piel durante la lactancia fortalece el lazo emocional entre mamá y bebé." },
