...
const levelData = {
  ...
  4: {
    ...
    labelZones: [
      ...
      { id: "barbilla", label: "Barbilla tocando el pecho", x: 58, y: 58, feedback: "La barbilla del bebe debe estar firmemente pegada al pecho de la mama. Esto asegura un agarre profundo y efectivo." },
