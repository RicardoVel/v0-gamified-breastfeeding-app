...
const levelData = {
  ...
  4: {
    ...
    labelZones: [
      ...
      { id: "barbilla", label: "Barbilla tocando el pecho", x: 48, y: 48, feedback: "La barbilla del bebe debe estar firmemente pegada al pecho de la mama. Esto asegura un agarre profundo y efectivo." },
