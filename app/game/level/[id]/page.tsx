...
const levelData = {
  ...
  4: {
    ...
    labelZones: [
      { id: "boca", label: "Boca bien abierta", x: 48, y: 48, feedback: "El bebe debe abrir bien la boca para lograr un agarre profundo que abarque gran parte de la areola, no solo el pezon." },
